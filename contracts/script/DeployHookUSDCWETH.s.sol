...
/// @title DeployHookUSDCWETH — Deploy DynamicFeeAuctionHook and install on existing EulerSwap pool
...
contract DeployHookUSDCWETH is Script {
    ...
    function run() external {
        ...
        // Pre-flight logging
        console.log("=== DeployHookUSDCWETH ===");
