...
contract DynamicFeeAuctionHookForkTest is Test {
    ...
    // ===================================================================
    // Test 1: Constructor initializes hook-specific state from real vaults
    // ===================================================================
    ...
    function test_fork_auction_trigger() public {
        ...
        // The hook triggers on relative exposure (NAV-based), not reserve-based.
    ...
    function test_fork_uniswap_price_oracle() public view {
        ...
        // Pool marginal price (concentration-aware)
        IEulerSwap.DynamicParams memory d = pool.getDynamicParams();
